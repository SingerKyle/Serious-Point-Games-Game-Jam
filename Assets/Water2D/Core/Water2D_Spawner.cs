namespace Water2D {
    ...
    public class Water2D_Spawner : MonoBehaviour
    {
        ...
        // You can reference the GameManager for playing sounds if needed
        ...
        [SerializeField] public AudioClip spawnSound;  // Sound for spawning particles
        [SerializeField] public AudioClip fillSound;   // Sound when shape is filled
        [SerializeField] public AudioClip collisionSound; // Sound for collision events
        private void Update()
        {
            CallShapeFillValidationUpdate();
        }
        ...
        public void Spawn(int count) {
            ...
            PlaySound(spawnSound);  // Play spawn sound
        ...
        public void InvokeOnShapeFill(GameObject obj, GameObject results)
        {
            ...
            PlaySound(fillSound);  // Play fill sound
        }
